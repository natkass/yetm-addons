...
#        return super(ProjectTask, self).create(vals)
    ...
    def custom_wo_send_joborder(self):
        ...
        try:
            ...
            template_id = self.env['ir.model.data']._xmlid_to_res_id('website_job_workorder_request.custom_wo_email_template_job_order_to_customer', raise_if_not_found=False)
        except ValueError:
            template_id = False
        try:
