...

{
    ...
    'summary': """Create material requisition and job order from maintenance request form.""",
    'description': """
...
- For more details please see Video on live preview or ask us by email...
    ...
    'live_test_url':  'https://probuseappdemo.com/probuse_apps/asset_mro_maintenance_management/267',#'https://youtu.be/CWL1ZJN68iY',
    'data':[
