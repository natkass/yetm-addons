...
{
    'name': 'Website Job Order/Work Order Form and Customer Portal',
    'currency': 'EUR',
...
""",
    ...
    # 'live_test_url': 'https://youtu.be/EjokwFnTweo',
    # 'live_test_url': 'https://youtu.be/_PxkFpISRNc',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/job_workorder_website_request/147',#'https://youtu.be/GuCZRFFfbY4',
    'data': [
        'views/task_report.xml',
        # 'datas/mail_templates_job_order.xml',
        # 'datas/mail_template_job_orders.xml',
        'datas/mail_template_job.xml',
