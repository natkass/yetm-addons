 ...
 */
export class ETTAHWPrinter extends BasePrinter {
    /**
     * @param {Object} params
    ...
    sendPrintAction(receipt, printer) {
        return this.rpc(`http://192.168.100.52:8069/orderpinter/printorder`, { receipt, printer });
