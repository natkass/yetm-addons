...
class ERCAMonthlyReport(models.AbstractModel):
    _name = 'report.erca_monthly_tax_report.template'
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        # Sheet setup
        sheet = workbook.add_worksheet('Vendor Bill Tax Report')
        sheet.write(0, 0, 'ERCA Monthly Vendor Bill Report')
