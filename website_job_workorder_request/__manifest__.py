...
""",
    ...
    'data': [
        ...
        'data/joborder_customer_mail_template_new.xml',
        # 'data/mail_templates_job_order.xml',
        # 'data/mail_templates_job_order_new.xml',#16
    ...
    # 'assets': {
    #         'web.assets_frontend': [
    #             'website_job_workorder_request/static/src/js/website_portal_templet.js',
    #     ],
    # },
    'installable': True,
    'auto_install': False,
